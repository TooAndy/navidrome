...
FROM --platform=$BUILDPLATFORM public.ecr.aws/docker/library/alpine:3.22 AS xx-build
...
########################################################################################################################
### Get TagLib
FROM --platform=$BUILDPLATFORM public.ecr.aws/docker/library/alpine:3.22 AS taglib-build
ARG TARGETPLATFORM
